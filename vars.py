...
BOT_TOKEN = os.environ.get("BOT_TOKEN", "AAGnNkx1jYS7c-PdQkwAJ4epnMerAcabIA4")

CREDIT = os.environ.get("CREDIT", "࿐ཽ༵༒ C H I N T U💛༒࿐ཽ༵")
...
OWNER_ID = int(os.environ.get("OWNER_ID", "7341535618"))
